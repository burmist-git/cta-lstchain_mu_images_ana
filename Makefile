...
runana: runana.cpp src/pixel_info.hh obj/pmtCameraHist.o obj/muonRingFitter.o obj/dbscan.o obj/dl1_muon_csv_reader.o obj/dl1_muon_ctapipe_csv_reader.o obj/plt.o obj/fov_lon_fov_lat_img_mask_reader.o
...
obj/fov_lon_fov_lat_img_mask_reader.o: src/fov_lon_fov_lat_img_mask_reader.cpp src/fov_lon_fov_lat_img_mask_reader.hh
	$(CXX) $(CXXFLAGS) -c -I. -o $@ $<
